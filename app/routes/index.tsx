                ...
                <nav aria-label="Breadcrumb" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <ol role="list" className="flex items-center space-x-4">
                        {product.breadcrumbs.map((breadcrumb) => (
                            <li key={breadcrumb.id}>
                                <div className="flex items-center">
                                    <a href={breadcrumb.href} className="mr-4 text-base text-gray-900 font-sofia-medium">
                                        {breadcrumb.name}
                                    </a>
                                    <svg
                                        viewBox="0 0 6 20"
                        ...
                        <li className="text-sm">
                            <a href={product.href} aria-current="page" className="text-base text-gray-500 hover:text-gray-600 font-sofia-medium">
                                {product.name}
                            </a>
                        </li>
                    </ol>
                            ...
                            <form>
                                ...
                                <div className="mt-8">
                                    <div className="flex items-center justify-between">
                                        <h2 className="text-sm font-medium text-gray-900">Available Options</h2>
                                        <a href="#" className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                                            See options chart
                                        </a>
                                    </div>
