...
async function login(password) {
  let hashedPass = await import_bcryptjs.default.hash("letmein", 10);
  return console.log(hashedPass), await import_bcryptjs.default.compare(
    password,
    hashedPass
  );
}
